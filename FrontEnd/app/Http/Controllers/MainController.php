...
class MainController extends Controller
{
    ...
    public function appointment() {
        ...
        // Retrieve appointments based on the user's email
        if ($user) {
            $appointments = Booking::where('email', $user->email)->get(); // Assuming the Booking table has an 'email' column
            ...
            return view('Mainfolder.profile', [
                'user' => $user,
                'profileImage' => $profileImage,
                'isAppointmentPage' => true, // Flag to indicate it's the appointments page
                'appointments' => $appointments // Pass user's appointments to the view
            ]);
        } else {
            return redirect()->route('Mainfolder.userHomepage')->with('error', 'User not found.');
        }
